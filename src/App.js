    ...
    render() {
        return (
            <svg viewBox="0 0 375 560">
                <polygon points="50,235 95,325 5,325" stroke="#005CFF" fill="#f1f1f1" onClick={this.getCurrent('n')}/>
                <polygon points="280,235 370,235 325,325" stroke="#005CFF" fill="#f1f1f1" onClick={this.getCurrent('s')}/>
